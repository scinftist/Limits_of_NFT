 ...
 * {ERC721Enumerable}.
 */
////////////////////warning this implementation is for educational perpose and it's diffrent
    ...
    IERC2309
{
    ...
    constructor(
        ...
        emit ConsecutiveTransfer(0, 4999, address(0), _preOwner);
    }
    ...
    function _ownerOf(uint256 tokenId) internal view returns (address) {
        ...
        if (tokenId < _maxSupply) {
            return
                _owners[tokenId] == address(0) ? _preOwner : _owners[tokenId];
        }else{
